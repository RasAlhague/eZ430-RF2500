...
#error "WARNING:  The Keil port is completely untested.  Proceed at your own risk."
#ifndef MCU_H
#error "ERROR:  The MCU include file must be specified.  Define MCU_H=<mcu_file.h> at the project level."
#endif
#include MCU_H
#define BSP_COMPILER_KEIL
#define __bsp_LITTLE_ENDIAN__   0
#define __bsp_CODE_MEMSPACE__   code
#define __bsp_XDATA_MEMSPACE__  xdata

#define __bsp_ISR_FUNC_DECLARATION__(f,v)   void f(void) interrupt v
#define __bsp_ISR_FUNC_PROTOTYPE__(f,v)     void f(void)
#define __bsp_ISR_FUNCTION__(f,v)           __bsp_ISR_FUNC_PROTOTYPE__(f,v); __bsp_ISR_FUNC_DECLARATION__(f,v)
