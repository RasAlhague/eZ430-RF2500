...
#ifndef BSP_NO_TYPES
typedef __bsp_int8_t__    int8_t;
typedef __bsp_int16_t__   int16_t;
typedef __bsp_int32_t__   int32_t;
typedef __bsp_uint8_t__   uint8_t;
typedef __bsp_uint16_t__  uint16_t;
typedef __bsp_uint32_t__  uint32_t;
#endif
...
#define BSP_ASSERT_HANDLER()       while(1)
#endif
